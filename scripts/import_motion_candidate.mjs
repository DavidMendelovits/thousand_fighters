...
if(reviewNotes)await approveMotionRow({repository,characterId,action:result.action,notes:reviewNotes,expectedFingerprint:(await motionFingerprint(await loadReviewContext(repository,characterId),result.action)).fingerprint});
