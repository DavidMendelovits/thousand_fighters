...
export type GrabSpec = {
  ...
  actorGrip?: { actor: FighterActorId; socketX: number; socketY: number; lift: number; swing: number; holdStartFrame?: number; holdEndFrame?: number; layerSplitY?: number };
  unblockable?: boolean;
};
...
export type CharacterConfig = {
  ...
  selectable?: boolean;
  parentId?: string;
  /** Installed form assets can live inside the parent's pinned asset bundle. */
