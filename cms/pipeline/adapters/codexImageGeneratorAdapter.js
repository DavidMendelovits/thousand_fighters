...
export class CodexImageGeneratorAdapter {
  ...
  async generateImage(request) {
    ...
    let release;generationQueue=new Promise(resolve=>{release=resolve;});
    await previous;
    try{return await this.generateImageExclusive(request);}finally{release();}
  }
  async generateImageExclusive(request) {
